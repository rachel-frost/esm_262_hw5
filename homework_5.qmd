---
title: "Assignment 5 - Modularity"
subtitle: "ESM 262"
date: "May 28, 2026"
author: "Alecia Dezzani & Rachel Frost"
format: 
  html:
...
This program helps agencies compare the costs of two options: no action (keeping the existing bridge) and constructing a new bridge. The option with the lowest cost will be chosen moving forward.
...
#time period to calculate NPV
time = 30

#river height at which the bridge floods
flood_threshold = 20

# Current Value of a Statistical Life (VSL) from the U.S. Department of Transportation ($ USD)
vsl = 7400000
...
Plus, a final comparison of the total costs of Option 1 vs Option 2
