...
# Use total flood events estimate to calculate the total NPV of all future flooding events. 
source(here("R/bridge_repair_cost.R"))

bridge_repair_NPV <- bridge_repair_cost(floods = event_count, costperflood = 1000000, discount = 0.07, time = 30)

repair_npv_format <- format(bridge_repair_NPV, big.mark = ",", scientific = FALSE)
sprintf("The total cost of fatalities from the existing bridge is estimated to be $%s.", repair_npv_format)
```
